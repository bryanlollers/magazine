@extends('layout.app')
@section('title') Privacy Policy | New Reader Magazine @endsection
@section('description') This privacy policy has been compiled to better serve those who are concerned with how their 'Personally Identifiable Information' (PII) is being used onli @endsection
@section('content')
<div class="full-container">
    <div class="row">
        <div id="left-section-privacy" class="col-md-7">
            <hr class="divider-post">
            <h2 class="active"> PRIVACY POLICY </h2>
            <p>
            ...
            <h5  class="active"> What personal information do we collect from the people that visit our blog, website or app?</h5>
            <p>
                When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, phone number or
                 other details to help you with your experience.

            </p>
      
            <h5  class="active">When do we collect information? </h5>
            <p>
                We collect information from you when you register on our site, place an order, subscribe to a newsletter or enter information on our site.
            </p>
            <h5  class="active"> How do we use your information? </h5>
            <p> 
            ...
            <h5  class="active"> How do we protect your information?</h5>
            <p>
            ...
            <h5 class="active"> Third-party disclosure </h5>
            <p> 
                ...
                so long as those parties agree to keep this information confidential. We may also release information when it's release is appropriate to comply with the law, enforce our site policies, or protect ours or others' rights, property or safety
            </p>
            <p>
                However, non-personally identifiable visitor information may be provided to other parties for marketing, advertising, or other uses.
            </p>
            <h5 class="active">Third-party links </h5>
            <p>
            ...
            <h5  class="active">California Online Privacy Protection Act </h5>
            <p> 
                ...
                The law's reach stretches well beyond California to require any person or company in the United States (and conceivably the world)
                 that operates websites collecting Personally Identifiable Information from California consumers to post a conspicuous privacy policy on its website
                  stating exactly the information being collected and those individuals or companies with whom it is being shared. - See more at: http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf
            </p> 
            <h5  class="active"> According to CalOPPA, we agree to the following: </h5>
            <p>
            ...
            <h5  class="active">How does our site handle Do Not Track signals? </h5>
            <p>
            ...
            <h5  class="active"> COPPA (Children Online Privacy Protection Act)</h5>
            <p>
                 When it comes to the collection of personal information from children under the age of 13 years old, 
                 the Children's Online Privacy Protection Act (COPPA) puts parents in control. The Federal Trade Commission, United States' consumer protection agency,
            ...
            <h5  class="active">Fair Information Practices</h5>
            <p> 
            ...
            <h5  class="active"> CAN SPAM Act </h5>
            <p>
                The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.
            </p>
            <h5  class="active"> We collect your email address in order to: </h5>
                <ul>
                    <li> 
            ...
            <h5  class="active"> To be in accordance with CANSPAM, we agree to the following: </h5>
            <ul>
                <li> 
            ...
            <h5  class="active">If at any time you would like to unsubscribe from receiving future emails, you can email us at</h5>
            <p>contact@newreadermagazine.com and we will promptly remove you from ALL correspondence.</p>
            <h5>Contacting Us</h5>
            <p>If there are any questions regarding this privacy policy, you may contact us using the information below. </p>
            <p>
                www.newreadermagazine.com<br>
                8th Flr 100 Church Street<br>
                Manhattan, New York 10007<br>
                USA<br>
                contact@newreadermagazine.com<br>
                1-800-734-7871
            </p>

        </div>
        <div id="right-section-privacy" class="col-md-5">
            <hr class="divider-post">
